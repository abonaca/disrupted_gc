...
- start ball there, sample w emcee
- 64 walkers advanced for 512 steps, discard first 256 steps as burn-in
- convergence test: just no motion in median, dispersion?
- median + 16 - 84 percentiles reported in Table
- in addition, we stored 1000 random posterior samples \footnote{available at the project repository \url{https://github.com/abonaca/disrupted_gc}}, and used them to propagate covariances into orbital parameters and cluster masses
