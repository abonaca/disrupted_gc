...
Theoretical studies of globular cluster dynamics predicted that stars escape globular clusters due to two-body relaxation and tidal stripping \citep[e.g.,][]{spitzer:1987, baumgardt03} and form long tidal tails along the cluster's orbit \citep{combes:1999}.
Such tidal tails were first detected around the Palomar~5 globular cluster \citep[Pal~5,][]{odenkirchen:2001, rockosi:2002}.
Stellar streams similar to Pal~5 in terms of width and length, but without a surviving progenitor, have been discovered throughout the Milky Way \citep[e.g.,][]{gd:2006, grillmair:2009, bonaca:2012, shipp:2018, ibata:2019}.

% Later data from SDSS, as well as other photometric and ast catalogs revealed a population of stellar streams throughout the Milky Way \citep[e.g.,][]{gd:2006, grillmair:2009, bonaca:2012, shipp:2016}.
% More recently, \citep[e.g.,][]{ibata:2019}.
% - followed by a number of streams w no progenitor cluster remaining, but presumed to be completely dissolved gc due to similarly narrow width (gd1, grillmair2009, bonaca2012, shipp2016, ibata2019)

- gravitational antennae: their morphology expected to trace global gravitational potential (johnston, lux2013, bonaca2014, bh2018), influence of lmc (erkal), the bar (pearson), and on small scale, even the presence of low-mass dark-matter subhalos (ibata, johnston, yoon)
- some curious features discovered (carlberg, pwb, bonaca2019a), interpreted as single impacts (bonaca2019b) or cumulative (banik)
- however, similar features from internal processes: epicycles (kuepper2008, kuepper2010) or preprocessing (carlberg, malhan)
- reduce grav potential aspect, include as tracers of galaxy assembly

- mass of the progenitor globular cluster determines much of its dynamical evolution
- is a requirement for construction of realistic models that fully capture internal processes
- disentangling the external, cosmologically important effects
