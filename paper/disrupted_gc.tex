...
However, these simulations remain out of reach because a cluster's dynamical evolution sensitively depends on its mass \citep[e.g.,][]{hh:2003}, and masses of most dissolved clusters are extremely uncertain \citep[e.g.,][]{erkal:2016b}.

- our goal here: estimate dynamical masses of completely disrupted globular clusters, now observed as stellar streams in the Milky Way
...
- additionally: masses would give us the contribution of gc to the mw (still uncertain, ref), put this population in the context of gc formation that appears to have a metallicity floor (ref)
