...
% - starting to recover this population, however still far from the initial slope
% - most expected to disrupt by tidal shocks in the disk early on (kruijssen2015b) -- wouldn't be observable as cold stellar streams today
% - pre-evaporation mass function -- anything interesting to learn from?
