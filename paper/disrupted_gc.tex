...
\tablehead{
Name & R.A. & Dec & d & $\mu_\alpha$ & $\mu_\delta$ & $V_r$ & $r_{peri}$ & $r_{apo}$\\
& deg & deg & kpc & mas/yr & mas/yr & km/s & kpc & kpc
% \colhead{Name} & \colhead{$r_{peri}$} & \colhead{$r_{apo}$}
}
\startdata
